...
import LoginPicture from '@/assets/images/logo.png';
import { BASE_TITLE } from '@/utils/variable';
import { Form, FormItem, Input, Button, Checkbox, Row, Col, message } from 'ant-design-vue';
import { UserOutlined, LockOutlined, MinusCircleOutlined } from '@ant-design/icons-vue';
import { getCaptchaImageApi, loginApi } from '@/api/login';
